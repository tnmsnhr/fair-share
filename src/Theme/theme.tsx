...
const tokens = {
  ...
  borderDark: { light: colors.gray200, dark: colors.gray200 },
  primary: { light: colors.primary900, dark: colors.primary950 },
  tertiary900: { light: colors.tertiary900, dark: colors.tertiary900 },
